...
<div class="woocommerce-form-login-toggle">
  ...
  <?php wc_print_notice(apply_filters('woocommerce_checkout_register_message', esc_html__('New customer?', 'woocommerce')) . ' <a href="/my-account" class="showRegister">' . esc_html__('Click here to register', 'woocommerce') . '</a>', 'notice'); ?>
</div>
<?php
