...
<div <?php wc_product_class('rental-single-product', $product); ?>>

  <?php
  /**
   * Hook: woocommerce_before_shop_loop_item.
   * @hooked prorental_product_img_wrapper_open - 9
   ...
   * @hooked prorental_product_img_wrapper_close - 15
   * @hooked prorental_product_content_wrapper_open - 20
   ...
   * @hooked prorental_product_content_wrapper_close - 10
   */
